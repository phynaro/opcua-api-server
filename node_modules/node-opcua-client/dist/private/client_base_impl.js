                ...
                if (err) {
                    ...
                    if (err.message.match("BadCertificateInvalid") ||
                        ...
                        return this.fetchServerCertificate(this.endpointUrl, (err1) => {
                            ...
                            const sha1Old = oldServerCertificate ? (0, node_opcua_crypto_1.makeSHA1Thumbprint)(oldServerCertificate) : null;
                            const sha1New = newServerCertificate ? (0, node_opcua_crypto_1.makeSHA1Thumbprint)(newServerCertificate) : null;
                            if (sha1Old === sha1New) {

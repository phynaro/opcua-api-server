...
exports.repair_client_sessions = exports.repair_client_session = exports._shouldNotContinue2 = exports._shouldNotContinue = void 0;
...
function repair_client_session_by_recreating_a_new_session(client, session, callback) {
    ...
    function recreateSubscription(subscriptionsToRecreate, innerCallback) {
        async_1.default.forEach(subscriptionsToRecreate, (subscriptionId, next) => {
            ...
            (0, client_subscription_reconnection_1.recreateSubscriptionAndMonitoredItem)(subscription).then(() => {
                doDebug &&

...
exports.clearSessionCache = exports.readNamespaceArray = exports.getArgumentDefinitionHelper = void 0;
/**
...
async function readNamespaceArray(session) {
    if (session.$$namespaceArray) {
        return session.$$namespaceArray;
    }
    ...
    session.$$namespaceArray = dataValue.value.value; // keep a cache
    return dataValue.value.value;
}
exports.readNamespaceArray = readNamespaceArray;
async function clearSessionCache(session) {
    session.$$namespaceArray = undefined;
}
